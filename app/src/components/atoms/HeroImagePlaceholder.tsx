export default function HeroImagePlaceholder() {
  return (
    <div className="relative h-full w-full bg-[#cbcbcd]">
      <div className="absolute left-1/2 top-1/2 flex h-[104px] w-[128px] -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-2xl bg-[#b8b8ba]">
        <svg
          aria-hidden="true"
          viewBox="0 0 74 55"
          className="h-[55px] w-[74px] fill-[#d7d7d9]"
        >
